...
public class PostgresCommunityBetRepository implements CommunityBetRepository {
    ...
    @Override
    public CommunityBet findById(long id) {

        CommunityBetEntity communityBetEntity = jpaCommunityBetRepository.findById(id);

        return CommunityBetAdapter.reverse(communityBetEntity);
    }
}
